...
extern "C" char* yassl_get_tty_password(const char*)
{
  return NULL;
}

extern "C" char* get_tty_password_ext(const char *msg, strdup_t f)
{
  return f(yassl_get_tty_password(msg),0);
}
                          ...
                          void * /* unused: callback_data */)
{
  ...
  passwd= get_tty_password_ext("Enter PEM pass phrase:",
                               yassl_mysql_strdup);
