...
MACRO(ADD_PROTOBUF target)
  ...
  MYSQLX_PROTOBUF_GENERATE_CPP(PROTO_SRCS PROTO_HDRS ${ARGN})
  ...
  TARGET_INCLUDE_DIRECTORIES(${target}_pb PRIVATE ${PROTOBUF_INCLUDE_DIRS})
  TARGET_INCLUDE_DIRECTORIES(${target} PRIVATE ${PROTOBUF_INCLUDE_DIRS})

  IF(PROTOBUF_LITE)
    TARGET_LINK_LIBRARIES(${target}_pb protobuf-lite)
  ELSE()
  ...
  IF(UNIX)
    set_property(TARGET ${target}_pb APPEND_STRING PROPERTY COMPILE_FLAGS "-w")
  ELSE(WIN32)
    set_property(TARGET ${target}_pb APPEND_STRING PROPERTY COMPILE_FLAGS
                 "/W1 /wd4018 /wd4996 /wd4244 /wd4267")
  ENDIF()

  message("Added Protobuf to target ${target}")
  if(PROTOBUF_LITE)
    message("Using lite version of Protobuf library")
  endif()
