...
class GroupReplicationStateChanged final :
 ...
 public:
  ...
  explicit constexpr GroupReplicationStateChanged(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* GroupReplicationStateChanged::release_view_id() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = view_id_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
