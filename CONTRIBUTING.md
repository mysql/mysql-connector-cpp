...
3. Develop your pull request.
4. Make sure you are aware of the requirements for the project (i.e. don't
   require C++20 if we are supporting C++17 and higher).
5. Validate your contribution by including tests that sufficiently cover the functionality.
6. Verify that the entire test suite passes with your code applied.
7. Submit your pull request via GitHub or uploading it using the contribution tab to a bug
