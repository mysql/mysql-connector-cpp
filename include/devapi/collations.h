...
/*
  List of builtin character sets and collations supported by version 5.7
...
struct CollationInfo
{
  ...
  /// String name of a collaction, such as "latin1_generic_ci".
...
/*
  The Colation<CS>::COLL constants are generated from information provided by
...
/*
  ...
  specialisation Collation<CS> of the Collation<> template and
  decalres collation constants within this specialization.

  The collation constant declaratios are generated by processing
  ...
  Collation constants decalred here are defined in file result.cc.
*/
