...
void example_fixture::createSchemaObject(String object_type, String object_name,
...
void example_fixture::dropSchemaObject(String object_type, String object_name)
{
  this->stmt->executeUpdate(String("DROP ") + object_type + " IF EXISTS "
                            + object_name);
}

void example_fixture::createTable(String table_name, String columns_and_other_stuff)
{
...
void example_fixture::dropTable(String table_name)
{
...
void example_fixture::logMsg(const String message)
{
  TestsListener::theInstance().messagesLog() << message << std::endl;
}

void example_fixture::logErr(const String message)
{
