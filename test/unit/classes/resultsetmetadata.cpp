...
void resultsetmetadata::init()
{
  ...
  columns.push_back(columndefinition("DATE", "YEAR", sql::DataType::DATE, "1901", true));
  columns.push_back(columndefinition("DATE", "YEAR(4)", sql::DataType::DATE, "2009", false));
  columns.push_back(columndefinition("DATE", "YEAR(2)", sql::DataType::DATE, "1", false));
